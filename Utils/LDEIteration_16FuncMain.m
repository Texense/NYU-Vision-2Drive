...
function [LDEEpoOut,L1DiffNorm,L1DiffNormNeib,L2Diameter,LDEIequv] = ...
...
for Epc = 1:Epoc
    ...
    L1DiffNormNeib(Epc) = ...
        mean(abs(LDEEpoOut{Epc}.S-LDEEpoOut{Epc+1}.S),'all')+...
        mean(abs(LDEEpoOut{Epc}.C-LDEEpoOut{Epc+1}.C),'all')+...
        mean(abs(LDEEpoOut{Epc}.I-LDEEpoOut{Epc+1}.I),'all');
