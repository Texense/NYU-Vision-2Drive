...
SaveToFolder = [CurrentFolder '/Data/Paper2_NetworkTuning/Fig1V4/'];
addpath(DataFolder)
...
for SIlgnInd = 1:aa
    for AngInd = 1:bb
        ...
        %% Read data
        ReadFolder = [SaveToFolder sprintf('SIlgnMpt%.3f_Ang%.1f/',SIlgnMpt,Grating)];
        MtpRcd(dirInd,1) = SIlgnMpt; MtpRcd(dirInd,2) = Grating;
        fprintf('SIlgnMpt%.3f_Ang%.1f/',SIlgnMpt,Grating)
...
save([SaveToFolder 'Paper3DriveNW_SIlgn.mat'],'BgFrs','DrvFrs','MtpRcd')