...
% for Edepression
load([SaveFolder sprintf('Paper3LocalTest-Edep_Rad%d_size%d_ID%d%s.mat',...
    RadiusInd,NSample,1,hStr)],'L2Diff_OneStepAll')
...
for SaveId = minId:maxId
    ...
    if isfile([SaveFolder sprintf('Paper3LocalTest-Edep_Rad%d_size%d_ID%d%s.mat',...
...
save([SaveFolder sprintf('Paper3LocalTestAll-Edep_Rad%d_IDRange%d-%d%s.mat',...
